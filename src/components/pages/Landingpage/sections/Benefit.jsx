...
const Benefit = () => {
  return (
    <div className="my-14 pb-16 h-[1050px] sm:h-[565px] flex flex-col sm:flex-row gap-y-20 sm:gap-x-32 items-center mx-auto section justify-center">
      <div className="min-w-96 max-w-[650px] text-center sm:text-left w-full px-5 sm:w-auto">
